...
import com.mora.cafe.com.mora.cafe.wrapper.ProductWrapper;
...
public interface ProductDao extends JpaRepository<NewProduct, Integer> {
    ...
    @Query("select new com.mora.cafe.com.mora.cafe.wrapper.ProductWrapper(np.productName, np.category, np.isAvailable, np.manufacturedDate, np.expirationDate) from NewProduct np")
